...
class ProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        //         Storage::delete('public/profile_pics/' . $user->profile_picture);
        //     }
            
        //     $filename = time() . '.' . $request->profile_pic->getClientOriginalExtension();
            
        //     // Store the file
        //     $request->profile_pic->storeAs('profile_pics', $filename);
        ...
        // $user->save(); // ✅ Now this should work since $user is an Eloquent model
