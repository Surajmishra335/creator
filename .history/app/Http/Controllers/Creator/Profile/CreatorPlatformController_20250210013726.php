...
use Symfony\Component\DomCrawler\Crawler; // Import DomCrawler
    ...
    public function getInstagramFollowers()
    {
        ...
        try {
            ...
            if (isset($matches[1])) {
                ...
                $followerCount = "Follower count not found.  Inspect Instagram's HTML."; // Handle cases where the pattern isn't found
            }
