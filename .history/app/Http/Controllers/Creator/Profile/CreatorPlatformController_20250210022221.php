...
class CreatorPlatformController extends Controller
{
    ...
    public function getTwitterFollowers()
    {
        ...
        try {
            ...
            // ***Finding the follower count (this is the tricky part and very likely to change)***

            // Inspect Twitter's HTML to find a reliable selector.  This is EXTREMELY
            // prone to breaking as Twitter changes its site structure.  The following
            // is an EXAMPLE and likely to become outdated quickly.

            // Example using a CSS selector (you'll need to inspect the actual Twitter page):
