      ...
      <div class="col-xl-4">
        ...
        <div class="card">
          <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
            ...
            <img src="{{ asset('creator/public/storage/profile_pics/' . auth()->user()->profile_picture) }}" width="100"
              height="100" class="rounded-circle">
            @else
            <img
              src="https://ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}&size=100&background=3498db&color=ffffff"
                ...
                <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-md-8 col-lg-9">
                      ...
                      @if(auth()->user()->profile_picture)
                      <img src="{{ asset('creator/public/storage/profile_pics/' . auth()->user()->profile_picture) }}"
